...
export class FileMimeTypeValidationPipe implements PipeTransform {
  private allowedImageMimeTypes = ['image/jpeg', 'image/png', 'image/webp', 'image/apng', 'image/gif', 'image/avif'];
  private allowedCvMimeTypes = ['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];
